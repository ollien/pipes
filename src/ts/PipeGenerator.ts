...
export default class PipeGenerator {
	 ...
	 * 						   Defaults to a function that selects a random position between -2 and 8 on each axis.
	 */
	constructor(
	...
	/**
	 * Generate a random position in space between -2 and 8 on each component
	 */
